package com.lalithsharma.hackathonpart1.food_and_beverages_activities;
...
public class food_and_beverages_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom_arrayList_food_and_beverages_page ob1 = new custom_arrayList_food_and_beverages_page(R.drawable.beverage,100,"Burger shop",
                "This is a burger shop which makes tasty burger","Large size burger, Medium size burger, Small size burger","Yes","Protein:10g \nCarbohydrates:8g\nFats:20g\nVitamin:1g");
